  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#14110f] px-5 py-20 text-center text-[#F5F1EE] sm:py-24" aria-labelledby="about-cta-title">
      ...
      <div className="mx-auto max-w-3xl">
        <p className="text-sm font-semibold uppercase tracking-[0.28em] text-[#D4A373]">Book with confidence</p>
        <h2 id="about-cta-title" className="mt-4 text-3xl font-semibold tracking-[-0.035em] text-white sm:text-4xl lg:text-5xl">
          Ready For Your Next Style?
        </h2>
        <p className="mx-auto mt-5 max-w-xl text-base leading-8 text-[#e8ddd3] sm:text-lg">
