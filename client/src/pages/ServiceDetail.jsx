  ...
  return (
    <article className="service-detail-page">
      <section className="service-detail-hero">
        <img alt="Representative protective styling image" src={getServicePreviewImage(service)} />
      ...
      <section className="service-detail-section"><p className="eyebrow">Finished With Care</p><h2>Style inspiration</h2><p>Representative styling images used for inspiration. Final results depend on your chosen service, hair type, length, and consultation.</p><div className="service-detail-gallery">{gallery.map((item) => <img alt={item.alt} loading="lazy" src={item.src} key={item.id} />)}</div></section>
